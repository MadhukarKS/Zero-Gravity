    ...
    <div className="relative bg-background text-foreground min-h-screen flex flex-col justify-between">
      ...
      <section className="relative pt-36 pb-16 px-6 border-b border-border overflow-hidden bg-grid">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <p className="mt-4 text-foreground/85 max-w-lg mx-auto text-sm md:text-base leading-relaxed">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full bg-background border border-border focus:border-yellow outline-none px-4 py-3 rounded-lg text-sm text-foreground placeholder:text-muted-foreground/45 transition-all duration-300 resize-none"
                  />
                </div>
              ...
              >
                ...
                <div className="pt-4 flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex-1 btn-yellow justify-center py-3 cursor-pointer shadow-md"
                  >
                    Send on WhatsApp
                  </a>
                  <button
