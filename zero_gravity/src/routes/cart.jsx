        ...
        <div className="max-w-6xl mx-auto">
          {items.length === 0 ? (
            <div className="card-dark p-16 text-center">
              <p className="text-foreground/60 mb-6 font-body">Your cart is empty. Time to gear up.</p>
            ...
            <div className="grid lg:grid-cols-[1fr_360px] gap-8 items-start">
              ...
              <aside className="card-dark p-6 lg:sticky lg:top-24">
                ...
                <div className="flex justify-between text-sm text-foreground/70 mb-2 font-body">
                  <span>Subtotal</span>
                  <span className="text-foreground font-semibold">{fmt.format(subtotal)}</span>
                </div>
                <div className="flex justify-between text-xs text-foreground/50 mb-6 font-body">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="btn-yellow w-full justify-center text-center cursor-pointer"
                >
                  Order Now via WhatsApp
                </a>
                <Link to="/accessories" className="btn-ghost-yellow w-full justify-center mt-3 text-center">
                  Continue Shopping
                </Link>
                <p className="text-[10px] tracking-[0.3em] uppercase text-foreground/40 text-center mt-6 font-semibold">
